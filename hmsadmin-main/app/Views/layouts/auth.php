        ...
        <div class="loginbox">
          ...
          <div class="login-right">
            <div class="login-right-wrap">
              ...
              <?php if (url_is('/auth')): ?>
                <div class="text-center forgotpass"><a href="<?= base_url() ?>/auth/forget_password">Forgot Password?</a>
                </div>
              <?php endif ?>
              ...
              <?php if (url_is('/auth/forget_password')): ?>
                <div class="text-center dont-have">Remember your password? <a href="<?= base_url() ?>/auth">Login</a>
                </div>
              <?php endif ?>

              <?php if (url_is('/auth/register')): ?>
                <div class="text-center dont-have">Already have an account? <a href="<?= base_url() ?>/auth">Login</a>
                </div>
              <?php endif ?>
