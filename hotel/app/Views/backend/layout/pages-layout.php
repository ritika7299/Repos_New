...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="<?php base_url('backend/vendors/images/apple-touch-icon.png'); ?>" />
    <link rel="icon" type="image/png" sizes="32x32"
        href="<?php base_url('backend/vendors/images/favicon-32x32.png'); ?>" />
    <link rel="icon" type="image/png" sizes="16x16"
        href="<?php base_url('backend/vendors/images/favicon-16x16.png'); ?>" />
...
<body>
    <div class="pre-loader">
        <div class="pre-loader-box">
            <div class="loader-logo">
                <img src="<?php base_url('backend/vendors/images/deskapp-logo.svg'); ?>" alt="" />
            </div>
    ...
    <!-- welcome modal end -->
    <!-- js -->
    <script src="<?php base_url('backend/vendors/scripts/core.js'); ?>"></script>
    <script src="<?php base_url('backend/vendors/scripts/script.min.js'); ?>"></script>
    <script src="<?php base_url('backend/vendors/scripts/process.js'); ?>"></script>
    <script src="<?php base_url('backend/vendors/scripts/layout-settings.js'); ?>"></script>
